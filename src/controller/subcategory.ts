...
export const getSubcategoriesAvailability = async (
  req: Request,
  res: Response
) => {
  try {
    ...
    const subcategoriesInCategoryIds = subcategoriesInCategory.map(
      (subcategory: any) => subcategory.subcategory_category.subcategoryid
    );
...
export const getSubcategories = async (_req: Request, res: Response) => {
  try {
    ...
    for (const subcategory of subcategories) {
      const existRegister = subcategoriesInList.find(
